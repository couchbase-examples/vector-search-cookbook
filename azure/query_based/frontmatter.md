...
title: Retrieval-Augmented Generation (RAG) with Couchbase and Azure OpenAI using Hyperscale and Composite Vector Index
short_title: RAG with Couchbase and Azure OpenAI using Hyperscale and Composite Vector Index
description:
