...
title: Retrieval-Augmented Generation (RAG) with Couchbase and Azure OpenAI using Search Vector Index
short_title: RAG with Couchbase and Azure OpenAI using Search Vector Index
description:
