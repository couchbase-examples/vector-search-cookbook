...
description:
  ...
  - For RAG using Hyperscale or Composite Vector Indexes, see: https://developer.couchbase.com/tutorial-crewai-couchbase-rag-with-hyperscale-or-composite-vector-index/
