...
def create_embeddings(api_key):
    """
    Creates and returns a JinaEmbeddings object.
    Args:
        api_key (str): The API key for Jina AI services.
    Returns:
        JinaEmbeddings: The created embeddings object.
    Raises:
...
def create_llm(jinachat_api_key):
    ...
    Args:
        jinachat_api_key (str): The API key for JinaChat services.
        model (str, optional): The model name to use. Defaults to "jina-clip-v1".
    Returns:
        JinaChat: The created language model object.
    Raises:
