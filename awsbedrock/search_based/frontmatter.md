...
title: Retrieval-Augmented Generation (RAG) with Couchbase and Amazon Bedrock using Search Vector Index
short_title: RAG with Couchbase and Amazon Bedrock using Search Vector Index
description:
